...
def load_model(name: str = "gpt2-small") -> HookedSAETransformer:
    model = HookedSAETransformer.from_pretrained(name, device = DeviceManager.instance().get_device())
...
def load_sae(release: str = "gpt2-small-res-jb", sae_id: str = "blocks.8.hook_resid_pre") -> SAE:
